var Modal = (function ($) {
    var $body = $(document.body),
        ...
        getTpl = function () {
            return ['<div class="modal fade" id="alert_modal" data-backdrop="false" data-show="false" data-keyboard="false">',
    ...
    ModalDialog.defaults = {
        ...
        buttons: [
            {
                html: '<button type="button" class="btn btn-sm btn-danger btn-ok">确定</button>',
                selector: '.btn-ok',
        ...
        Proxy = function (isAlert) {
            return function () {
                ...
                var msg = typeof arguments[0] === 'string' && arguments[0] || arguments[0].msg || '',
                    ...
                    width = typeof arguments[0] === 'object' && arguments[0].width || '100%',
                ...
                if(!modal) {
                    modal = new Modal({
                        ...
                        onContentReady: function(){
                            ...
                            $modal_dialog.css({'margin-top': 240 ,'margin-left':'0px'});
                        }
